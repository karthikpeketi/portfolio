    ...
    <div className="mx-auto flex items-center justify-center pt-36 md:pt-40 lg:pt-52" id="about">
      <div className="flex gap-6 justify-between items-center max-md:flex-wrap max-xl:justify-center">
        ...
        >
          ...
          >
            <motion.a
              href="https://drive.google.com/file/d/1he36qANvuzRl3zG4vUx3Jxt68DLLgDqO/view?usp=drive_link"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative px-8 py-3 bg-gradient-to-r from-sky-400 to-indigo-500 text-white rounded-full font-semibold overflow-hidden transition-shadow duration-300 hover:shadow-lg hover:shadow-sky-500/25"
            ...
            >
              <span className="relative z-10 text-sm">View Resume</span>
